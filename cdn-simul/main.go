...
func main() {
	...
	var firstBypass, useSessionDu, useDeleteLru, useFileSize, useTimeWeight, useIdeal bool
	...
	flag.BoolVar(&useIdeal, "ideal-storage", false, "ideal storage mode (filebase)")
